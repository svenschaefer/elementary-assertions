...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| s1 | (a) WebShop | is (predicate_quality=low) |  | (an) online store |  |  |  | actor(r=0,t=2); attribute(r=0,t=3); operators(r=0,t=0) |
| s1 | people | can pick products | they |  |  |  | modality(can) | actor(r=0,t=1); theme(r=0,t=1); operators(r=0,t=0) |
| s1 | people | want to buy | them |  | shopping cart |  | control_inherit_subject, control_propagation, coordination_group(cg:6c9330bb9124), coordination_group(cg:6c9330bb9124:and) | actor(r=0,t=1); location(r=0,t=2); theme(r=0,t=1); operators(r=0,t=0) |
| s1 |  | put | them |  | into a shopping cart | modifier:then | coordination_group(cg:6c9330bb9124) | location(r=0,t=4); modifier(r=0,t=1); theme(r=0,t=1); operators(r=0,t=0) |
| s1 |  | complete | purchase |  |  |  |  | theme(r=0,t=1); operators(r=0,t=0) |
| s1 | (the) purchase | placing an order |  |  |  |  |  | actor(r=0,t=2); operators(r=0,t=0) |
| s2 | (the) shop | needs | (the) items | available |  | complement_clause:make ; modifier:actually | control_inherit_subject, control_propagation | actor(r=0,t=2); attribute(r=0,t=1); complement_clause(r=0,t=1); modifier(r=0,t=1); theme(r=0,t=2); operators(r=0,t=0) |
| s2 |  | are (predicate_quality=low) |  | available |  |  | coordination_group(cg:e48944270340), coordination_group(cg:e48944270340:and) | attribute(r=0,t=1); operators(r=0,t=0) |
| s2 |  | take | customer’s payment |  |  |  | coordination_group(cg:e48944270340), coordination_group(cg:e48944270340:and) | theme(r=0,t=3); operators(r=0,t=0) |
| s2 |  | keep | record of the order |  |  |  | coordination_group(cg:e48944270340) | theme(r=0,t=4); operators(r=0,t=0) |
