...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| s1 | Prime factorization | decomposes | positive integer |  | set of prime numbers |  |  | actor(r=0,t=2); location(r=0,t=4); theme(r=0,t=2); operators(r=0,t=0) |
| s2 |  | factor |  |  |  |  | coordination_group(cg:cc06689f5bae), coordination_group(cg:cc06689f5bae:and), quantifier(each\|t14) | operators(r=0,t=0) |
| s2 | (each) factor | be (predicate_quality=low) |  | prime |  |  |  | actor(r=0,t=2); attribute(r=0,t=1); operators(r=0,t=0) |
| s2 | their product | equal | original number |  |  |  | modality(must) | actor(r=0,t=2); theme(r=0,t=2); operators(r=0,t=0) |
| s3 | (the) process | starts | prime factor |  |  | modifier:typically, smallest | coordination_group(cg:8d8920912124), coordination_group(cg:8d8920912124:and) | actor(r=0,t=2); modifier(r=0,t=2); theme(r=0,t=2); operators(r=0,t=0) |
| s3 | (the) process | continues iteratively |  |  |  |  | coordination_group(cg:8d8920912124) | actor(r=0,t=2); operators(r=0,t=0) |
| s4 |  | used | Prime factorization |  | in number theory | modifier:commonly |  | location(r=0,t=3); modifier(r=0,t=1); theme(r=0,t=2); operators(r=0,t=0) |
