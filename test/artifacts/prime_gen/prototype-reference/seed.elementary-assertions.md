...
| --- | --- | --- | --- | --- | --- | --- | --- |
| s1 | (a) prime number generator | produces | prime numbers | ascending order |  |  | actor(r=0,t=4); location(r=0,t=2); theme(r=0,t=2); operators(r=0,t=0) |
| s2 | It | starts |  | at a given minimum value | attached_theme:minimum value |  | actor(r=0,t=1); attached_theme(r=0,t=2); location(r=0,t=5); operators(r=0,t=0) |
| s2 |  | tests each successive integer for primality | successive integer for primality |  |  | coordination_group(cg:80849c2ebf98), quantifier(each\|t21) | theme(r=0,t=4); operators(r=0,t=0) |
| s3 | (the) generator | ensure | only numbers |  | modifier:greater | compare_gt(t36), modality(must), quantifier(only\|t32) | actor(r=0,t=2); modifier(r=0,t=1); theme(r=0,t=2); operators(r=0,t=0) |
| s3 | (the) generator | considered |  |  |  |  | actor(r=0,t=2); operators(r=0,t=0) |
| s4 |  | used | basic numerical experiments |  | beneficiary:for educational purposes | modality(may) | beneficiary(r=0,t=3); theme(r=0,t=3); operators(r=0,t=0) |
